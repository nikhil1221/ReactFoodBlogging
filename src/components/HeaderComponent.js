...
import {Nav,Navbar,Jumbotron,NavbarBrand,NavbarToggler,Collapse,NavItem,ModalHeader, Button, Form, FormGroup, Label, Modal, ModalBody, Input} from 'reactstrap';
  ...
  render(){
      return(
        ...
        <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
            <ModalHeader toggle={this.toggleModal} title>Login</ModalHeader>
            <ModalBody>
